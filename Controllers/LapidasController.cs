...
{
    public class LapidasController : Controller
    {
        private readonly ApplicationDbContext _context;

        public LapidasController(ApplicationDbContext context)
        {
            _context = context;
        }
